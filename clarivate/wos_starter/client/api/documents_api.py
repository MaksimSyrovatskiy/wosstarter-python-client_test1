...
from clarivate.wos_starter.client.api_client import ApiClient, Endpoint as _Endpoint
...
class DocumentsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.documents_get_endpoint = _Endpoint(
            settings={
        ...
        self.documents_uid_get_endpoint = _Endpoint(
            settings={
                'response_type': (Document,),
                'auth': [],
                'endpoint_path': '/documents/{uid}',
                'operation_id': 'documents_uid_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def documents_get(
        ...
        **kwargs
        ...
        >>> thread = api.documents_get(q, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['q'] = \
            q
        return self.documents_get_endpoint.call_with_http_info(**kwargs)
    ...
    def documents_uid_get(
        ...
        **kwargs
        ...
        """documents_uid_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.documents_uid_get(uid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['uid'] = \
            uid
        return self.documents_uid_get_endpoint.call_with_http_info(**kwargs)
