...
from clarivate_wos_starter_client import rest
from clarivate_wos_starter_client.configuration import Configuration
from clarivate_wos_starter_client.exceptions import ApiTypeError, ApiValueError, ApiException
from clarivate_wos_starter_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.documents_get  # this is an instance of the class Endpoint
        api_instance.documents_get()  # this invokes api_instance.documents_get.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.documents_get.callable or self.callable in this class
